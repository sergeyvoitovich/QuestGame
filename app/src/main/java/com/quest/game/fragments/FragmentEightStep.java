 ...
 */
public class FragmentEightStep extends Fragment{
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_main_8, null);
       iFragment.changeTimer((TextView)view.findViewById(R.id.timer),view);
        initImages();
        initButtons();

        new CountDownTimer(3000, 350)
        {
            ...
            public void onTick(long paramAnonymousLong)
            {
                ...
                if (tick_count == 5)
                {
                    images.get(8).setImageResource(R.drawable.red_off);
                    images.get(9).setImageResource(R.drawable.red_off);
                }
                if (tick_count == 6)
                {
                    images.get(10).setImageResource(R.drawable.red_off);
                    images.get(11).setImageResource(R.drawable.red_off);
                }
                if (tick_count == 7)
                {
                    images.get(12).setImageResource(R.drawable.red_off);
                    images.get(13).setImageResource(R.drawable.red_off);
    ...
    private void initImages() {
       images.add((ImageView) view.findViewById(R.id.charge_1));
        images.add((ImageView) view.findViewById(R.id.charge_2));
        images.add((ImageView) view.findViewById(R.id.charge_3));
        images.add((ImageView) view.findViewById(R.id.charge_4));
        images.add((ImageView) view.findViewById(R.id.charge_5));
        images.add((ImageView) view.findViewById(R.id.charge_6));
